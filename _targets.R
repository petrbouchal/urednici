...
l_szu_plots <- list(
  ...
  tar_target(szu_plot_prum,
             plot_mini_bar(szu_sections, prumerny_plat, rok = 2023,
                           title = "Průměrné platy na ministerstvech, 2023",
                           subtitle = "Kč hrubého za měsíc (FTE), služební i pracovní místa; jen ústřední orgány")),

  tar_target(szu_plot_prum_real,
             plot_mini_line(szu_sections, prumerny_plat_c2023,
                            title = "Průměrné platy na ministerstvech, 2003-2023, v cenách roku 2023",
                            subtitle = "Služební i pracovní místa; jen ústřední orgány")),
  tar_target(szu_plot_bar_pay_latest,
             plot_mini_line(szu_sections, prumerny_plat_c2023,
                            title = "Průměrné platy na ministerstvech, 2023, v cenách roku 2023",
                            subtitle = "Služební i pracovní místa; jen ústřední orgány")),

  tar_target(szu_plot_vucinh,
             plot_mini_line(szu_sections, prumerny_plat_vucinh,
                            title = "Průměrné platy na ministerstvech ve srovnání s průměrným platem v Praze, 2003-2023",
                            subtitle = "Služební i pracovní místa; jen ústřední orgány",
                            girafe = TRUE,
  ...
  tar_target(szu_plot_mezirocne,
             plot_mini_line(szu_sections, prumerny_plat_vucinh_mezirocne,
                            ...
                            title = "Změna reálných platů na ministerstvech, 2004-2023",
                            subtitle = "Služební i pracovní místa; jen ústřední orgány",
