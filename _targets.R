...
l_szu_plots <- list(
  ...
  tar_target(szu_plot_prum,
             plot_mini_bar(szu_sections, prumerny_plat, rok = 2022,
                            title = "Průměrné platy na ministerstvech, 2022",
  ...
  tar_target(szu_plot_bar_pay_latest,
             plot_mini_line(szu_sections, prumerny_plat_c2022,
                            title = "Průměrné platy na ministerstvech, 2022, v cenách roku 2022",
                            subtitle = "Služební i pracovní místa; jen ústřední orgány")),
